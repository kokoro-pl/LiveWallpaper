...
public class LiveWallpaperService extends WallpaperService implements SharedPreferences.OnSharedPreferenceChangeListener {
	...
	public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String s) {
		...
		if (!sharedPreferences.getBoolean(LiveWallpaperSettings.BACKGROUND_ENABLED_CHECKBOX_KEY, true)) {
			mEngine.enableBackground( sharedPreferences.getBoolean(LiveWallpaperSettings.BACKGROUND_ENABLED_CHECKBOX_KEY, true) );
		}
	...
	class MyEngine extends Engine implements Renderer.RendererCallback {
		...
		public MyEngine() {
			...
			// @todo: Обрабатывать отсутствие фона
...
//            roughBitmap = null;
		...
		// @todo: Реализовать включение и отключение фона на лету
		public void enableBackground( Boolean isEnable )
		{
